...
for fidIdx=1:nFids
    ...
    locFrGlobFid=winFrGlobFid + fidsKernelLength + fidsValues(fidIdx) - window_width;      % put it into "complete potvals" frame
    ...
    if testing
        ...
        indFids(fidIdx).value=indivFids + fidsKernelLength + fidsValues(fidIdx) - window_width;
    end
